  ...
  return (
    <div className="fixed bottom-5 left-5 z-30 animate-float">
      <a
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-lift ring-2 ring-white/50 transition-transform hover:scale-110"
      >
